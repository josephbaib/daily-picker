...
import { makeParticles, nextFrame, cancelFrame, makeBuffer, plate, drawTiled, lightPool } from './scene.js?v=83b88d3-1828';
import { drawActor, placeTags, fxFrame, FX_ASSET, makeTitles } from './stage.js?v=83b88d3-1828';
