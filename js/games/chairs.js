...
import { makeParticles, nextFrame, cancelFrame, makeBuffer, plate, drawTiled, glow, lightPool } from './scene.js?v=83b88d3-1828';
import { litSprite, placeTags, makeFx, FX_ASSET, makeTitles } from './stage.js?v=83b88d3-1828';
