...
import { makeParticles, nextFrame, cancelFrame, makeBuffer, plate, drawTiled, glow, pixLabel } from './scene.js?v=85f63d0-1718';
import { litSprite, placeTags, makeFx, fxFrame, FX_ASSET } from './stage.js?v=85f63d0-1718';
