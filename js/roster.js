...
export const ROSTER = {
  ...
  // Макс: заказной лист в духе Минато (нарезан tools/slice-sheet.py --nogrid)
  'Макс': { sheet: 'custom/max_sheet.png' },
  ...
  // Юсуф: собственный лист Наруто (нарисован по заказу, нарезан в раскладку LPC скриптом tools/slice-sheet.py)
  'Юсуф': { sheet: 'custom/naruto_sheet.png' },
};
